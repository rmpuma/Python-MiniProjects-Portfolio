...
def revisar_check():
    ...
    for c in cuadros_postre:
        if variables_postre[x].get() == 1:
            cuadros_postre[x].config(state=tk.NORMAL)
            if cuadros_postre[x].get() == '0':
                cuadros_postre[x].delete(0, tk.END)
            cuadros_postre[x].focus()
        else:
            cuadros_postre[x].config(state=tk.DISABLED)
...
def recibo():
    ...
    texto_recibo.insert(tk.END, '*' * 57 + '\n')
    texto_recibo.insert(tk.END, 'Items\t\tCant.\tCosto Items\n')
    texto_recibo.insert(tk.END, '-' * 62 + '\n')
    
    x = 0
    for comida in texto_comida:
        if comida.get() != '0':
            texto_recibo.insert(tk.END, f'{lista_comidas[x]}\t\t{comida.get()}\t'
    ...
    texto_recibo.insert(tk.END, f' Costo del postre: \t\t\t{var_costo_postre.get()}\n')
    texto_recibo.insert(tk.END, '-' * 62 + '\n')
    texto_recibo.insert(tk.END, f' Sub-total: \t\t\t{var_subtotal.get()}\n')
    texto_recibo.insert(tk.END, f' Impuestos: \t\t\t{var_impuesto.get()}\n')
    texto_recibo.insert(tk.END, f' Total: \t\t\t{var_total.get()}\n')
    texto_recibo.insert(tk.END, '*' * 57 + '\n')
    texto_recibo.insert(tk.END, 'Lo esperamos pronto')
...
# panel superior  tipos de borde[flat,raised,sunken,groove,ridge]
panel_superior = tk.Frame(aplicacion, bd=1, relief=tk.FLAT)
panel_superior.pack(side=tk.TOP)

# etiqueta titulo
etiqueta_titulo = tk.Label(panel_superior, text='Sistema de Facturación', fg='azure4',
                           font=('Dosis', 50), bg='burlywood', width=27)
etiqueta_titulo.grid(row=0, column=0)

# panel izquierdo
panel_izquierdo = tk.Frame(aplicacion, bd=1, relief=tk.FLAT)
panel_izquierdo.pack(side=tk.LEFT)

# panel costos
panel_costos = tk.Frame(panel_izquierdo, bd=1, relief=tk.FLAT, bg='azure4', padx=55)
panel_costos.pack(side=tk.BOTTOM)

# panel comidas
panel_comidas = tk.LabelFrame(panel_izquierdo, text='Comida', font=('Dosis', 19, 'bold'),
                              bd=1, relief=tk.FLAT, fg='azure4')
panel_comidas.pack(side=tk.LEFT)

# panel bebidas
panel_bebidas = tk.LabelFrame(panel_izquierdo, text='Bebidas', font=('Dosis', 19, 'bold'),
                              bd=1, relief=tk.FLAT, fg='azure4')
panel_bebidas.pack(side=tk.LEFT)

# panel postres
panel_postres = tk.LabelFrame(panel_izquierdo, text='Postres', font=('Dosis', 19, 'bold'),
                              bd=1, relief=tk.FLAT, fg='azure4')
panel_postres.pack(side=tk.LEFT)

# panel derecha
panel_derecha = tk.Frame(aplicacion, bd=1, relief=tk.FLAT)
panel_derecha.pack(side=tk.RIGHT)

# panel calculadora
panel_calculadora = tk.Frame(panel_derecha, bd=1, relief=tk.FLAT, bg='burlywood')
panel_calculadora.pack()

# panel recibo
panel_recibo = tk.Frame(panel_derecha, bd=1, relief=tk.FLAT, bg='burlywood')
panel_recibo.pack()

# panel botones
panel_botones = tk.Frame(panel_derecha, bd=1, relief=tk.FLAT, bg='burlywood')
panel_botones.pack()
...
for comida in lista_comidas:
    ...
    comida = tk.Checkbutton(panel_comidas, 
                            text=comida.title(), 
                            font= ('Dosis', 19, 'bold'), 
                            onvalue=1, 
                            offvalue=0, 
    ...
    cuadros_comida[contador] = tk.Entry(panel_comidas,
                                 font=('Dosis', 18, 'bold'),
                                 bd=1,
                                 width=6,
                                 state=tk.DISABLED,
...
for bebida in lista_bebidas:
    ...
    bebida = tk.Checkbutton(panel_bebidas, 
                            text=bebida.title(), 
                            font= ('Dosis', 19, 'bold'), 
                            onvalue=1, 
                            offvalue=0, 
    ...
    cuadros_bebida[contador] = tk.Entry(panel_bebidas,
                                 font=('Dosis', 18, 'bold'),
                                 bd=1,
                                 width=6,
                                 state=tk.DISABLED,
...
for postre in lista_postres:
    ...
    cuadros_postre[contador] = tk.Entry(panel_postres,
                                 font=('Dosis', 18, 'bold'),
                                 bd=1,
                                 width=6,
                                 state=tk.DISABLED,
...
etiqueta_costo_postre = tk.Label(panel_costos,
                                 text='Costo Postre', 
                                 font=('Dosis', 12, 'bold'),
                                 bg='azure4',
                                 fg='white')
...
texto_costo_postre = tk.Entry(panel_costos,
                           font=('Dos', 12, 'bold'),
                           bd=1,
                           width=10,
                           state='readonly',
...
etiqueta_subtotal = tk.Label(panel_costos,
                                 text='Subtotal', 
                                 font=('Dosis', 12, 'bold'),
                                 bg='azure4',
                                 fg='white')
...
texto_subtotal = tk.Entry(panel_costos,
                           font=('Dos', 12, 'bold'),
                           bd=1,
                           width=10,
                           state='readonly',
...
etiqueta_impuesto = tk.Label(panel_costos,
                                 text='Impuesto', 
                                 font=('Dosis', 12, 'bold'),
                                 bg='azure4',
                                 fg='white')
...
texto_impuesto = tk.Entry(panel_costos,
                           font=('Dos', 12, 'bold'),
                           bd=1,
                           width=10,
                           state='readonly',
...
etiqueta_total = tk.Label(panel_costos,
                                 text='Total', 
                                 font=('Dosis', 12, 'bold'),
                                 bg='azure4',
                                 fg='white')
...
texto_total = tk.Entry(panel_costos,
                           font=('Dos', 12, 'bold'),
                           bd=1,
                           width=10,
                           state='readonly',
